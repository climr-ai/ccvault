...
BARBARIAN = ClassInfo(
    ...
    features=[
        ...
        ClassFeature("Weapon Mastery (3 weapons)", 4, "You can use the mastery property of three kinds of weapons.", ruleset="dnd2024"),
        ...
        ClassFeature("Weapon Mastery (4 weapons)", 10, "You can use the mastery property of four kinds of weapons.", ruleset="dnd2024"),
...
FIGHTER = ClassInfo(
    ...
    features=[
        ...
        ClassFeature("Weapon Mastery (4 weapons)", 4, "You can use the mastery property of four kinds of weapons.", ruleset="dnd2024"),
        ClassFeature("Ability Score Improvement", 8, "Increase one ability score by 2, or two ability scores by 1, or take a feat."),
        ...
        ClassFeature("Weapon Mastery (5 weapons)", 10, "You can use the mastery property of five kinds of weapons.", ruleset="dnd2024"),
        ClassFeature("Weapon Mastery (6 weapons)", 16, "You can use the mastery property of six kinds of weapons.", ruleset="dnd2024"),
        ClassFeature("Ability Score Improvement", 16, "Increase one ability score by 2, or two ability scores by 1, or take a feat."),
...
ROGUE = ClassInfo(
    ...
    features=[
        ...
        ClassFeature("Weapon Mastery", 1, "You can use the mastery property of two kinds of Simple or Martial weapons that have the Light or Finesse property. When you finish a long rest, you can change the weapons you have selected.", ruleset="dnd2024"),
